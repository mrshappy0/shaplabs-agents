...
import { startDiscordGateway } from '../server/discord-gateway';
...
export const mastra = new Mastra({
  workflows: { weatherWorkflow, dockerUpdateCycleWorkflow, dockerApplyUpdatesWorkflow, dockerCronWorkflow,
